...
import simpleProject2.john.schema.trumpia.GetDistributionLists;
import simpleProject2.john.simpleProject2.App;

public class DistributionListsTest {
	GetDistributionLists lists;
	...
	@Before
	public void before() {
		App.trumpiaUserID = "paulkim";
		App.key = "594c862a4bfe227e3a537be359d3381b";
		headers.put("Content-Type", "application/json");
		headers.put("X-Apikey", App.key);
	}
	
	@Test
	public void test() throws IOException {
		lists = new GetDistributionLists();
